...
#         self.attention = SDPAttention2(temperature=np.power(d_k, 0.5))
#         self.layer_norm = nn.LayerNorm(d_model)
...
#         self.attention = SDPAttention3(temperature=np.power(d_k, 0.5))
#         self.layer_norm = nn.LayerNorm(d_model)
...
#         self.BN = nn.BatchNorm1d(SIG_LEN2)
...
#         self.BN = nn.BatchNorm1d(SIG_LEN3)
